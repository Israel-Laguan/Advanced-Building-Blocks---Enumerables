...
RSpec.describe Enumerable do
  describe '#my_each' do
    context 'must complain when no block is given' do
      it do
        expect { test_arr.my_each }.to raise_error('Please provide a block')
      end
    end
  ...
  describe '#my_each_with_index' do
    context 'must complain when no block is given' do
      it do
        expect { test_arr.my_each_with_index }.to raise_error('Please provide a block')
      end
    end
  ...
  describe '#my_all' do
    context 'must complain when no block is given' do
      it do
        expect { test_arr.my_all? }.to raise_error('Please provide a block')
      end
    end
  ...
  describe '#my_any' do
    context 'must complain when no block is given' do
      it do
        expect { test_arr.my_any? }.to raise_error('Please provide a block')
      end
    end
  ...
  describe '#my_count' do
    context 'is identical to #count using parameter' do
      it do
        expect(test_arr.my_count(5)).to eq(0)
      end
    end
  ...
  describe '#none' do
    context 'must complain when no block is given' do
      it do
        expect { test_arr.my_none? }.to raise_error('Please provide a block')
      end
    end
  ...
  describe '#select' do
    context 'must complain when no block is given' do
      it do
        expect { test_arr.my_select }.to raise_error('Please provide a block')
      end
    end
  ...
  describe '#map' do
    context 'must complain when no block is given' do
      it do
        expect { test_arr.my_map }.to raise_error('Please provide a block')
      end
    end
  ...
  describe '#inject' do
    context 'must complain when no block is given' do
      it do
        expect { test_arr.my_inject }.to raise_error('Please provide a block')
      end
    end
